...
public final class ModBlocks
{
    ...
    public static Block totemSpawner;
    ...
    public static void init()
    {
        ...
        totemSpawner = new BlockTotemSpawner(BlockIds.TOTEM_SPAWNER);
        ...
        GameRegistry.registerBlock(totemSpawner, Strings.TOTEM_SPAWNER_NAME);
