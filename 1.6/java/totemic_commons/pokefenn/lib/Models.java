...
public class Models
{
    ...
    public static final String MODEL_LOCATION = "/assets/totemic/models/";
    ...
    public static final String CHLOROPHYLL_CRYSTAL = MODEL_LOCATION + "chlorophyllCrystal.obj";
    public static final String TOTEM_INTELLIGENCE = MODEL_LOCATION + "totemIntelligence.obj";
