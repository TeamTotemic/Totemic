...
public final class ModItems
{
    ...
    public static void init()
    {
        ...
        chlorophyllCrystal = new ItemVerdantCrystal(ItemIds.VERDANT_CRYSTAL);
        ...
        blazingChlorophyllCrystal = new ItemBlazingVerdantCrystal(ItemIds.BLAZING_VERDANT_CRYSTAL);
