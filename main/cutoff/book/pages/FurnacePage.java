...
public class FurnacePage extends BookPage
{
    ...
    public void readPageFromXML(Element element)
    {
        ...
        if (nodes != null)
            icons = TotemicClientRegistry.getRecipeIcons(nodes.item(0).getTextContent());
    }
    ...
    public void renderContentLayer(int localWidth, int localHeight)
    {
        ...
        manual.renderitem.renderItemAndEffectIntoGUI(manual.fonts, manual.getMC().renderEngine, TotemicClientRegistry.getManualIcon("coal"), (localWidth + 38) / 2, (localHeight + 110) / 2);
    ...
    private static final ResourceLocation background = new ResourceLocation("totemic", "textures/gui/bookfurnace.png");
