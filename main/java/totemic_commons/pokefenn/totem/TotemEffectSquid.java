...
public class TotemEffectSquid implements ITotemEffect
{
    ...
    public static void effect(TileTotemBase totemBase)
    {
        ...
        if (totemBase.getStackInSlot(SLOT_TWO).itemID == ModItems.chlorophyllCrystal.itemID)
        {
            ...
            if (EntityUtil.getEntitiesInRange(totemBase.worldObj, totemBase.xCoord, totemBase.yCoord, totemBase.zCoord, 10, 10) != null  && !(totemBase.getStackInSlot(totemBase.SLOT_TWO).getMaxDamage() - totemBase.getStackInSlot(totemBase.SLOT_TWO).getItemDamage() - totemBase.DECREASE_SQUID <= 0))
            {
                ...
                for (Entity entity : EntityUtil.getEntitiesInRange(totemBase.worldObj, totemBase.xCoord, totemBase.yCoord, totemBase.zCoord, 10, 10))
                {
                    if (entity instanceof EntityPlayer)
                    {
                        ...
                        totemBase.chlorophyllCrystalHandler(totemBase.DECREASE_SQUID);
