...
public class TotemEffectCactus implements ITotemEffect
{
    ...
    public void effect(TileTotemBase totemBase)
    {
        ...
        if (totemBase.getStackInSlot(SLOT_TWO).itemID == ModItems.chlorophyllCrystal.itemID)
        {
            ...
            if (EntityUtil.getEntitiesInRange(totemBase.worldObj, totemBase.xCoord, totemBase.yCoord, totemBase.zCoord, 10, 10) != null && totemBase.getStackInSlot(SLOT_TWO).getItemDamage() - totemBase.DECREASE_CACTUS >= 0)
            {
