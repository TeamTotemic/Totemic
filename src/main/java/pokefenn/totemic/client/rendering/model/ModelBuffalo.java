...
public class ModelBuffalo extends ModelBase
{
    ...
    private void renderPumpkin(Entity entity, float scale)
    {
        ...
        Minecraft.getMinecraft().getItemRenderer().renderItem((EntityLivingBase) entity, pumpkin, ItemCameraTransforms.TransformType.HEAD);
    }
