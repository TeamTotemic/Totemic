...
public final class ModContent
{
    ...
    public static void ceremonies(RegistryEvent.Register<Ceremony> event)
    {
        ...
        event.getRegistry().registerAll(
            ...
            zaphkielWaltz = new CeremonyZaphkielWaltz("totemic:zaphkielWaltz", 110, 22 * 20,
            ...
            eagleDance = new CeremonyEagleDance("totemic:eagleDance", 200, 30 * 20,
            ...
            baykokSummon = new CeremonyBaykok("totemic:baykokSummon", 240,  40 * 20,
