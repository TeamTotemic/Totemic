...
public final class ModItems {
    ...
    public static final RegistryObject<SpawnEggItem> bald_eagle_spawn_egg = REGISTER.register("bald_eagle_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.bald_eagle, 0x4B4136, 0xF5E6A3, new Properties().tab(Totemic.creativeTab)));
    public static final RegistryObject<SpawnEggItem> baykok_spawn_egg = REGISTER.register("baykok_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityTypes.baykok, 0xE0E0E0, 0xF8DAD2, new Properties().tab(Totemic.creativeTab)));
    ...
    public static final RegistryObject<TotemBaseItem> totem_base = REGISTER.register("totem_base", () -> new TotemBaseItem(ModBlocks.totem_base.get(), new Properties().tab(Totemic.creativeTab)));
