...
public class TotemicAdvancementProvider extends AdvancementProvider {
    ...
    private static void generate(Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper efh) {
        ...
        var windChimeUnlocked = new Advancement.Builder()
                ...
                .addCriterion("performed_fertility", performed(ModContent.fertility.get()))
        ...
        var rattleUnlocked = new Advancement.Builder()
                ...
                .requirements(Strategy.OR)
                .addCriterion("performed_buffalo_dance", performed(ModContent.buffalo_dance.get()))
        ...
        new Advancement.Builder()
                ...
                .requirements(Strategy.OR)
                .addCriterion("performed_eagle_dance", performed(ModContent.eagle_dance.get()))
    ...
    private static Criterion<CeremonyTrigger.TriggerInstance> performed(Ceremony ceremony) {
