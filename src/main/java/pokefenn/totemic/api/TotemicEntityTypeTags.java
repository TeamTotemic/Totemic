...
public final class TotemicEntityTypeTags {
     ...
     */
    public static final TagKey<EntityType<?>> HYMN_OF_MATURITY_BLACKLIST = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(TotemicAPI.MOD_ID, "hymn_of_maturity_blacklist"));
}
