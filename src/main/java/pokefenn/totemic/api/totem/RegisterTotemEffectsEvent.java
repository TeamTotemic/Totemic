...
/**
 * Register your Totem Effects when you receive this event, using the {@link #register} or {@link #registerAll} methods.
 * Please do <b>not</b> use Forge's {@link RegistryEvent}!<p>
 * This allows us to register Totem Effects before blocks, so we can dynamically add Totem Pole blocks for each Totem Effect.
 */
public class RegisterTotemEffectsEvent extends Event {
