...
public interface TotemEffectAPI {
     ...
     * @see #getDefaultRange(TotemCarving, int, int, TotemEffectContext)
     */
     ...
     */
    int getDefaultRange(TotemCarving effect, int repetition, TotemEffectContext context);
     ...
     * @see #getDefaultRange(TotemCarving, int, TotemEffectContext)
     */
    int getDefaultRange(TotemCarving effect, int repetition, int baseRange, TotemEffectContext context);
}
