...
public interface MusicAcceptor
{
    ...
    /**
     * Returns the priority of the Music Acceptor. Higher priority acceptors will receive music before other acceptors. The music will be
     * evenly split between acceptors with the same priority.
     *
     * As a reference, Totem Bases which are not currently in a Ceremony will have the default priority of 0, while Totem Bases that are in
     * one will have a priority of 16.
     */
