...
public interface MusicAPI {
     ...
     * @param instr  the instrument.
     */
    void playMusic(Entity entity, MusicInstrument instr);
     ...
     * @param instr  the instrument.
     */
    void playSelector(Level level, Vec3 pos, Entity entity, MusicInstrument instr);
     ...
     * @param instr  the instrument.
     */
    void playSelector(Entity entity, MusicInstrument instr);
     ...
     * @param instr  the instrument.
     */
    void playSelector(Level level, BlockPos pos, Entity entity, MusicInstrument instr);
     ...
     * @param range  the range. The default value is given by {@link #DEFAULT_RANGE}.
     */
    void playSelector(Level level, Vec3 pos, Entity entity, MusicInstrument instr, int range);

    //TODO: Add convenience methods that dispatch to playMusic or playSelector depending on whether the entity is sneaking
}
