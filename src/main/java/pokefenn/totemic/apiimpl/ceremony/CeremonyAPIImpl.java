...
public enum CeremonyAPIImpl implements CeremonyAPI {
    ...
    public double getStartupTimeMultiplier(Difficulty diff) {
        return switch(diff) {
            case PEACEFUL, EASY -> TotemicConfig.SERVER.ceremonyStartupTimeMultiplierEasy.get();
            case NORMAL         -> TotemicConfig.SERVER.ceremonyStartupTimeMultiplierNormal.get();
            case HARD           -> TotemicConfig.SERVER.ceremonyStartupTimeMultiplierHard.get();
        };
    }
}
