...
public interface TotemicKubeJSEvents {
    ...
    TargetedEventHandler<ResourceKey<Ceremony>> ceremonySelection = GROUP.common("ceremonySelection", () -> CeremonyKubeEvent.Selection.class).supportsTarget(CEREMONY_TARGET);
