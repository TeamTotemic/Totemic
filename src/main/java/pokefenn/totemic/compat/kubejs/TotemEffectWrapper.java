...
public interface TotemEffectWrapper {
    ...
    static TotemEffect potion(MobEffect mobEffect) {
    ...
    static TotemEffect potion(MobEffect mobEffect, boolean scaleAmplifier) {
    ...
    static TotemEffect potion(MobEffect mobEffect, boolean scaleAmplifier, int interval) {
