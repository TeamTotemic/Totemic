 ...
 */
public class CeremonyRainRemoval extends Ceremony
{
    public CeremonyRainRemoval(String modid, String name, int musicNeeded, CeremonyTime maxStartupTime, CeremonyTime effectTime,
