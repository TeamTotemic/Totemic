...
public class BlockTotemBase extends Block implements ITileEntityProvider, TotemicStaffUsage
{
    ...
    public boolean onTotemicStaffRightClick(World world, BlockPos pos, EntityPlayer player, ItemStack stack)
    {
        ...
        {
            player.addChatComponentMessage(new ChatComponentTranslation("totemicmisc.isDoingNoCeremony"));
        }
        else if(tile.getState() instanceof StateSelection)
        {
            ...
            player.addChatComponentMessage(new ChatComponentTranslation("totemicmisc.isDoingSelection"));
            player.addChatComponentMessage(new ChatComponentTranslation("totemicmisc.selection", selectors));
        }
