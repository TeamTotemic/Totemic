...
public class ModelBaykok extends ModelBiped
{
    ...
    public ModelBaykok()
    {
        ...
        ribs.setTextureSize(128, 128);
        ribs.mirror = true;
        setRotation(ribs, 0F, 0F, 0F);
        quiver = new ModelRenderer(this, 16, 56);
        quiver.addBox(-5F, -2F, 2F, 4, 11, 2);
        quiver.setRotationPoint(0F, 0F, 0F);
        quiver.setTextureSize(128, 128);
        quiver.mirror = true;
