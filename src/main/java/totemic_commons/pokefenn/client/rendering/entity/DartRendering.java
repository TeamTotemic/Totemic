...
public class DartRendering extends RenderArrow
{
    public void renderDarts(EntityBaseDart entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderDarts((EntityBaseDart) par1Entity, par2, par4, par6, par8, par9);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity par1)
    {
        if(par1 instanceof EntityBaseDart)
        {
            return new ResourceLocation("totemic:textures/models/" + ItemDarts.DART_NAMES[((EntityBaseDart) par1).metadata] + ".png");
        }
