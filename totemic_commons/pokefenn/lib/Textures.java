...
public class Textures {
    ...
    public static final String TOTEM_SQUID_ITEM_ICON = "totemSquid";
    public static final String TOTEM_CACTUS_ITEM_ICON = "totemCactus";
    public static final String TOTEM_HORSE_ITEM_ICON = "totemHorse";
    public static final String TOTEM_BAT_ITEM_ICON = "totemBat";
