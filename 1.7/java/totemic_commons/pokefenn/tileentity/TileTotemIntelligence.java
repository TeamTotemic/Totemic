...
import totemic_commons.pokefenn.network.packets.IPacket;
...
public class TileTotemIntelligence extends TileTotemic implements IInventory
{
    ...
    public void increaseChlorophyll(int subtration)
    {
        ...
        if (this.getStackInSlot(SLOT_ONE) != null && this.getStackInSlot(SLOT_ONE).getItem() == ModItems.chlorophyllCrystal || this.getStackInSlot(SLOT_ONE) != null && this.getStackInSlot(SLOT_ONE).getItem() == ModItems.blazingChlorophyllCrystal && this.getStackInSlot(SLOT_ONE).getItemDamage() < this.getStackInSlot(SLOT_ONE).getMaxDamage())
        {
    ...
    {
        return metadata == 11 && this.getStackInSlot(SLOT_ONE).getItem() == ModItems.blazingChlorophyllCrystal || metadata == 11 && this.getStackInSlot(SLOT_ONE).getItem() == ModItems.chlorophyllCrystal || !(metadata != 11 && this.getStackInSlot(SLOT_ONE).getItem() == ModItems.blazingChlorophyllCrystal) && !(this.getStackInSlot(SLOT_ONE).getMaxDamage() - this.getStackInSlot(SLOT_ONE).getItemDamage() - subtraction <= 0);
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemStack)
    {
        if (!this.worldObj.isRemote)
        {
            if (i == SLOT_ONE && getStackInSlot(SLOT_ONE) == null && itemStack.getItem() == ModItems.chlorophyllCrystal)
            {
