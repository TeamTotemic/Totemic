...
import totemic_commons.pokefenn.network.packets.PacketTileWithItemUpdate;
...
public class TileChlorophyllSolidifier extends TileTotemic implements IInventory, IFluidHandler
{
    ...
    public IPacket getDescriptionPacket()
    {
        ...
        if (itemStack != null)
        {
            return new PacketTileWithItemUpdate(xCoord, yCoord, zCoord, orientation, state, customName, itemStack.getItem().getUnlocalizedName(), itemStack.getItemDamage(), itemStack.stackSize);
